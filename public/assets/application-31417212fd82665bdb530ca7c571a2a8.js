...
(function() { this.JST || (this.JST = {}); this.JST["messages/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>New Message</h1>\n\n<section class="new-message group">\n  <form class="new-message-form" id="new-message-form">\n    \n    <section class="new-message-sender">\n      <label for="receiver">Send message to</label>\n    \n      <select id = "receiver" name="message[receiver_id]">\n        ');  friends.forEach( function(friend){ ; __p.push('\n          <option value="',  friend.id ,'" ',  defaultFriend == friend ? "selected" : "" ,'>',  friend.showName() ,'</option>\n        ');  }); ; __p.push('\n      </select>\n    </section>\n\n    <textarea id="body" name="message[body]" spellcheck="true" placeholder="Say something, interesting or not!">\n    </textarea>\n    \n    <div class="submit">\n      <input type="submit" name="commit" value="Send">\n    </div>\n  </form>\n</section>\n<a href="#">Cancel and go back to index</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["messages/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<article class="received-messages">\n  <a href="#new">Send a message</a>\n  <h2>Received Messages</h2>\n\n    <table>\n      <tbody>\n      <tr>\n        <td>Sender</td>\n        <td>Message</td>\n        <td>Sent</td>\n      </tr>\n    ');  receivedMessages.forEach( function(message) { ; __p.push('\n      <tr>\n        <td>',  message.sender().showName() ,'</td>\n        <td><a href="',  "#/" + message.get("id") ,'">\n          ',  message.escape("body").slice(0,50),'\n        </a></td>\n        <td>',  moment(message.escape("created_at")).fromNow() ,'\n      </tr>\n    ');  }); ; __p.push('\n    </tbody>\n  </table>\n\n\n</article>\n\n<article class="sent-messages">\n\n  <h2>Sent Messages</h2>\n\n    <table>\n      <tbody>\n      <tr>\n        <td>Receiver</td>\n        <td>Message</td>\n        <td>Sent</td>\n      </tr>\n    ');  sentMessages.forEach( function(message) { ; __p.push('\n      <tr>\n        <td>',  message.receiver().showName() ,'</td>\n        <td><a href="',  "#/" + message.get("id") ,'">\n          ',  message.escape("body").slice(0,50),'\n        </a></td>\n        <td>',  moment(message.escape("created_at")).fromNow() ,'\n      </tr>\n    ');  }); ; __p.push('\n    </tbody>\n  </table>\n\n</article>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["messages/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<article class="received-messages">\n\n  <h2>Received Messages</h2>\n\n    <table>\n      <tbody>\n      <tr>\n        <td>Sender</td>\n        <td>Message</td>\n        <td>Sent</td>\n      </tr>\n    ');  thread.forEach( function(message) { ; __p.push('\n      <tr>\n        <td>',  message.sender().get("name") ? message.sender().get("name") : message.sender().get("email") ,'</td>\n        <td><a href="',  "#/" + message.get("id") ,'">\n          ',  message.escape("body"),'\n        </a></td>\n        <td>',  moment(message.escape("created_at")).fromNow() ,'\n      </tr>\n    ');  }); ; __p.push('\n    </tbody>\n  </table>\n\n\n  <a href="#new">Send a message</a>\n  <a href="#">Back to index</a>\n</article>\n\n\n');}return __p.join('');};
}).call(this);
...
Unraveled.Collections.Friends = Backbone.Collection.extend({

  model: Unraveled.Models.Friend,
